...
args__4742__auto__.push((arguments[i__4737__auto___26080]));
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq26033){
var G__26034 = cljs.core.first(seq26033);
var seq26033__$1 = cljs.core.next(seq26033);
var G__26035 = cljs.core.first(seq26033__$1);
var seq26033__$2 = cljs.core.next(seq26033__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26034,G__26035,seq26033__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__26048_SHARP_){
return (!((cljs.core.meta(p1__26048_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26056__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e26062){var _e__25690__auto__ = e26062;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e26064){var _e__25690__auto__ = e26064;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__26066 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__26067 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__26067);

try{var map__26068 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26068__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__26066);
}});
...
var temp__5733__auto___26091 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___26091)){
var managed_print_level_26092 = temp__5733__auto___26091;
var _STAR_print_level_STAR__orig_val__26075_26094 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__26076_26095 = managed_print_level_26092;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__26076_26095);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__26074_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__26074_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__26075_26094);
}} else {
job_fn();
}
