...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__27211_SHARP_,p2__27210_SHARP_){
return p2__27210_SHARP_.toUpperCase();
}));
...
while(true){
if(cljs.core.seq(m)){
var G__27248 = cljs.core.rest(m);
var G__27249 = (function (){var entry = cljs.core.first(m);
...
var G__27215 = o1;
goog.object.extend(G__27215,o2);
...
while(true){
if(cljs.core.seq(m)){
var G__27252 = cljs.core.rest(m);
var G__27253 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__27256 = cljs.core.rest(m);
var G__27257 = (function (){var entry = cljs.core.first(m);
