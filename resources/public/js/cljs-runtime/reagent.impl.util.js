...
reagent.impl.util.react = (((typeof React !== 'undefined'))?React:(((typeof require !== 'undefined'))?(function (){var or__4126__auto__ = require("react");
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.util !== 'undefined') && (typeof reagent.impl.util.create_class !== 'undefined')){
} else {
reagent.impl.util.create_class = (((typeof createReactClass !== 'undefined'))?createReactClass:(((typeof require !== 'undefined'))?(function (){var or__4126__auto__ = require("create-react-class");
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
var vec__27031 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
var seq__27032 = cljs.core.seq(vec__27031);
var first__27033 = cljs.core.first(seq__27032);
var seq__27032__$1 = cljs.core.next(seq__27032);
var start = first__27033;
var parts = seq__27032__$1;
...
var self__ = this;
var self__ = this;
var G__27041 = (arguments.length - (1));
switch (G__27041) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args27040){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args27040)));
}));
...
var _STAR_always_update_STAR__orig_val__27042 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__27043 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__27043);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__27042);
}} else {
