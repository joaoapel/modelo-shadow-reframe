...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26326 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26326(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26327 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26327(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26328 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26328(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26332 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26332(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26334 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26334(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26335 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26335(reader);
}
});
...
var G__26347 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26348 = s.append(c);
c = G__26347;
s = G__26348;
continue;
}
