...
var G__26039 = devtools.prefs.pref(v);
v = G__26039;
continue;
} else {
return v;
...
}catch (e26002){var _e__25690__auto__ = e26002;
return false;
}})();
...
}catch (e26009){var _e__25690__auto__ = e26009;
return false;
}})();
...
}catch (e26013){var _e__25690__auto__ = e26013;
return false;
}}
}
});
...
var or__4126__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
var and__4115__auto__ = (function (){var or__4126__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
var vec__26020 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26020,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26020,(1),null);
...
var and__4115__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__4115__auto__)){
...
return cljs.core.some((function (p1__26025_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__26025_SHARP_);
}),template);
});
