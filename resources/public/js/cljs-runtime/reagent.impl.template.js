...
var G__27256 = o;
(G__27256[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__27294__delegate = function (args){
...
while (G__27295__i < G__27295__a.length) {G__27295__a[G__27295__i] = arguments[G__27295__i + 0]; ++G__27295__i;}
  args = new cljs.core.IndexedSeq(G__27295__a,0,null);
} 
return G__27294__delegate.call(this,args);};
G__27294.cljs$lang$maxFixedArity = 0;
G__27294.cljs$lang$applyTo = (function (arglist__27296){
var args = cljs.core.seq(arglist__27296);
return G__27294__delegate(args);
});
...
var G__27276 = jsprops;
(G__27276["defaultValue"] = value);

(G__27276["onChange"] = (function (p1__27274_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__27274_SHARP_);
}));
...
var vec__27278 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27278,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27278,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27278,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___27308 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___27308 == null)){
} else {
var key_27309 = temp__5739__auto___27308;
(jsprops["key"] = key_27309);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__27282 = reagent.impl.template.__GT_NativeWrapper();
(G__27282["name"] = c);
...
var G__27283 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__27283) : reagent.impl.template.as_element.call(null,G__27283));
} else {
...
var len__4736__auto___27311 = arguments.length;
var i__4737__auto___27312 = (0);
while(true){
if((i__4737__auto___27312 < len__4736__auto___27311)){
args__4742__auto__.push((arguments[i__4737__auto___27312]));

var G__27313 = (i__4737__auto___27312 + (1));
i__4737__auto___27312 = G__27313;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq27286){
var G__27287 = cljs.core.first(seq27286);
var seq27286__$1 = cljs.core.next(seq27286);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27287,seq27286__$1);
}));
...
break;
default:
var G__27315 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__27315;
continue;
...
var n__4613__auto___27316 = a.length;
var i_27317 = (0);
while(true){
if((i_27317 < n__4613__auto___27316)){
(a[i_27317] = reagent.impl.template.as_element((a[i_27317])));

var G__27319 = (i_27317 + (1));
i_27317 = G__27319;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4613__auto___27321 = a.length;
var i_27323 = (0);
while(true){
if((i_27323 < n__4613__auto___27321)){
var val_27324 = (a[i_27323]);
if(((cljs.core.vector_QMARK_(val_27324)) && ((reagent.impl.template.key_from_vec(val_27324) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_27323] = reagent.impl.template.as_element(val_27324));

var G__27328 = (i_27323 + (1));
i_27323 = G__27328;
continue;
} else {
}
...
var ctx = ({});
var vec__27290 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27290,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27290,(1),null);
...
var G__27293 = (cljs.core.count(argv) - first_child);
switch (G__27293) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv((function (a,k,v){
if((k >= first_child)){
