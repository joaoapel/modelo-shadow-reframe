...
var G__27100 = cljs.core.next(xs);
var G__27101 = cljs.core.next(ys);
xs = G__27100;
ys = G__27101;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__27083 = val;
var G__27084 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
...
while(true){
if((n < cnt)){
var nval = (function (){var G__27085 = val__$1;
var G__27086 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__27085,G__27086) : f.call(null,G__27085,G__27086));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__27087 = val__$1;
var G__27088 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
...
var G__27109 = cljs.core.next(es);
var G__27110 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__27109;
tcoll__$1 = G__27110;
continue;
} else {
...
var G__27111 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
