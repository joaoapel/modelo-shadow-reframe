...
var o25802 = temp__5733__auto__;
var temp__5733__auto____$1 = (o25802["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o25803 = temp__5733__auto____$1;
return (o25803["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__25679__auto__ = f;
return (o__25679__auto__["toString"]).call(o__25679__auto__);
} else {
return "";
}
}catch (e25805){var _ = e25805;
return "";
}});
...
try{var o__25679__auto___25997 = t;
(o__25679__auto___25997["cljs$lang$ctorPrWriter"]).call(o__25679__auto___25997,t,writer);
}catch (e25817){var __25998 = e25817;
}
...
var char_code = (function (){var o__25679__auto__ = (new String(char$));
return (o__25679__auto__["charCodeAt"]).call(o__25679__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__25679__auto__ = String;
return (o__25679__auto__["fromCharCode"]).call(o__25679__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25834 = num_code;
switch (G__25834) {
case (1):
return (185);
...
var o__25679__auto__ = String;
return (o__25679__auto__["fromCharCode"]).call(o__25679__auto__,superscript_code);
});
/**
...
}catch (e25841){var _e__25690__auto__ = e25841;
return false;
}})())){
...
var vec__25847 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25847,(0),null);
...
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25898,(0),null);
...
var G__26011 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__26012 = cljs.core.butlast(remaining_tokens);
name_tokens = G__26011;
remaining_tokens = G__26012;
continue;
}
}
break;
...
var vec__25905 = cljs.core.split_with((function (p1__25904_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__25904_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25905,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25905,(1),null);
...
var vec__25917 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25917,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25917,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__26016 = cljs.core.rest(remaining_tokens);
var G__26017 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__26016;
name_tokens = G__26017;
continue;
} else {
...
var vec__25925 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25925,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25925,(1),null);
var vec__25928 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25928,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25928,(1),null);
var vec__25931 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25931,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25931,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25931,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25931,(3),null);
...
var vec__25951 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25951,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25951,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25951,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25951,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25951,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25951,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__25954 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25954,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25954,(1),null);
var vec__25957 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25957,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25957,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__25961 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__25961) : devtools.munging.parse_fn_info_deep.call(null,G__25961));
})()));
}
} else {
return fn_info;
...
var G__26023 = (arity + (1));
var G__26024 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25965){
var vec__25966 = p__25965;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25966,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25966,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25969_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__25969_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25970_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__25970_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___26028 = arguments.length;
var i__4737__auto___26029 = (0);
while(true){
if((i__4737__auto___26029 < len__4736__auto___26028)){
args__4742__auto__.push((arguments[i__4737__auto___26029]));

var G__26030 = (i__4737__auto___26029 + (1));
i__4737__auto___26029 = G__26030;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25973){
var vec__25974 = p__25973;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25974,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25971){
var G__25972 = cljs.core.first(seq25971);
var seq25971__$1 = cljs.core.next(seq25971);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25972,seq25971__$1);
}));
...
var G__25977 = arg;
var G__25977__$1 = (((G__25977 instanceof cljs.core.Keyword))?G__25977.fqn:null);
switch (G__25977__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25978__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25978__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25978__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25978__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25979 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25979,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25979,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25979,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25979,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25979,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25979,(5),null);
...
var o__25679__auto__ = f;
return (o__25679__auto__["getBasis"]).call(o__25679__auto__);
});
/**
...
}catch (e25983){var _e__25690__auto__ = e25983;
...
var G__26046 = (obj[cljs.core.first(path)]);
var G__26047 = cljs.core.rest(path);
obj = G__26046;
path = G__26047;
continue;
} else {
...
var _STAR_ = (function (accum,p__25984){
var vec__25985 = p__25984;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25985,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25985,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25988){
var vec__25989 = p__25988;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25989,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25989,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25989,(2),null);
...
var post_process = (function (p__25993){
var vec__25994 = p__25993;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25994,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25994,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25992_SHARP_){
return (obj[cljs.core.first(p1__25992_SHARP_)]);
}),sorted_matches);
